...
# --- HARDWARE-DATENBANK (3 Stufen: Main Showcase, Mid-Tier Sweet Spot, Budget P/L) ---
HARDWARE_DATA = {
    "main_build": {
        "name": "⭐ Ultra-Premium Studio-Showcase (Main-Build)",
        "items": [
            {"id": "m_cpu", "part": "Prozessor (CPU)", "model": "AMD Ryzen 9 9950X3D (16 Kerne / V-Cache)", "price": 699.00, "shop": "Caseking Bundle", "url": "https://geizhals.de/?fs=AMD+Ryzen+9+9950X3D", "is_bundle": True},
            ...
            {"id": "m_gpu", "part": "Grafikkarte (GPU)", "model": "ASUS TUF Gaming GeForce RTX 5070 Ti 16G OC", "price": 1219.00, "shop": "Notebooksbilliger", "url": "https://geizhals.de/?fs=ASUS+TUF+Gaming+GeForce+RTX+5070+Ti", "is_bundle": False},
            ...
            {"id": "m_ssd", "part": "Festplatte (SSD)", "model": "Samsung 990 PRO 1TB NVMe M.2", "price": 199.05, "shop": "Mindfactory", "url": "https://geizhals.de/?fs=Samsung+990+PRO+1TB", "is_bundle": False},
    ...
    "mid_build": {
        ...
        "items": [
            ...
            {"id": "mid_ssd", "part": "Festplatte (SSD)", "model": "Samsung 990 PRO 1TB NVMe M.2", "price": 199.05, "shop": "Notebooksbilliger", "url": "https://geizhals.de/?fs=Samsung+990+PRO+1TB", "is_bundle": False},
            {"id": "mid_case", "part": "Gehäuse", "model": "Fractal Design North XL Dark TG", "price": 155.01, "shop": "Notebooksbilliger", "url": "https://geizhals.de/?fs=Fractal+Design+North+XL+Dark+TG", "is_bundle": False},
            {"id": "mid_cool", "part": "Kühlung (AiO)", "model": "NZXT Kraken Elite 360 RGB Schwarz", "price": 279.59, "shop": "Notebooksbilliger", "url": "https://geizhals.de/?fs=NZXT+Kraken+Elite+360+RGB", "is_bundle": False},
            {"id": "mid_psu", "part": "Netzteil (PSU)", "model": "be quiet! Straight Power 12 850W ATX 3.0", "price": 160.00, "shop": "Mindfactory", "url": "https://geizhals.de/?fs=be+quiet!+Straight+Power+12+850W", "is_bundle": False},
            {"id": "mid_fans", "part": "Gehäuselüfter", "model": "NZXT F140 RGB Core (140mm)", "price": 30.00, "shop": "Mindfactory", "url": "https://geizhals.de/?fs=NZXT+F140+RGB+Core", "is_bundle": False}
        ]
    },
    "alt_build": {
        "name": "📉 Preis-Leistungs-Sieger (Budget-Build)",
        "items": [
            {"id": "a_cpu", "part": "Prozessor (CPU)", "model": "AMD Ryzen 7 7800X3D", "price": 389.00, "shop": "Mindfactory", "url": "https://geizhals.de/?fs=AMD+Ryzen+7+7800X3D", "is_bundle": False},
...
def run_claude_decision(deal_briefing, rate, main_total, mid_total, alt_total):
    """Claude liefert das Kaufurteil für alle 3 Stufen mit robuster Modell-Kaskade."""
    ...
    Gib in 3 präzisen Sätzen auf Deutsch ein Urteil ab: Welches der drei Builds bietet aktuell das beste Verhältnis aus Leistung, Ästhetik und Budget? Jetzt kaufen oder warten?
    """
    ...
    return (
        f"Das High-End Setup ({main_total:.2f} €) liefert maximale Spitzenleistung im Showcase. "
        f"Der Studio Sweet-Spot ({mid_total:.2f} €) bietet die ideale Balance aus edler Holzoptik und solider 12-Kern-Power, "
        f"während der P/L-Sieger ({alt_total:.2f} €) die maximale Ersparnis darstellt."
    )
...
def manage_history(main_total, mid_total, alt_total):
    ...
    if len(history) < 30 or "mid_total" not in history[0]:
        history = []
...
<body>
    <div class="container">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-title">⭐ High-End Showcase</div>
...
def send_discord_notification(decision, deal_briefing, main_total, mid_total, alt_total):
    ...
    payload = {
        "content": (
            ...
            f"**Main Showcase:** {main_total:.2f} € | **Mid-Tier:** {mid_total:.2f} € | **P/L-Sieger:** {alt_total:.2f} €\n\n"
